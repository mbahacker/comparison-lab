...
export default function Page() {
  return <main id="main" className="shell prose-page">
    ...
    <p>Alhena Research Lab is operated by Alhena. We use your work email to verify access to detailed reports. New tool analysis requests also require your name and work email so we can review the request and send approval and completion updates.</p>
    <h2>Report access</h2>
