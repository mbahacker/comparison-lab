...
import { studyMetaDescription } from '@/lib/study-findings';
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return { title: study.title, description, alternates: { canonical: `/studies/${study.slug}`, types: { 'application/json': '/study-scores.json' } }, openGraph: { title: study.title, description, type: 'article' as const, publishedTime: study.publishedAt }, twitter: { card: 'summary_large_image' as const, title: study.title, description } };
}
